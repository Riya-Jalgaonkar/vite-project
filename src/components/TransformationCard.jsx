...
export default function TransformationCard({ image, name, message }) {
  return (
    ...
    <div className="bg-white/90 rounded-2xl shadow-md p-6 flex flex-col items-center text-center space-y-4 border-4 border-[#0ABAB5] hover:shadow-lg transition">
